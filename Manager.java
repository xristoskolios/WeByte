...
public class Manager extends User {
	...
	public void getMenu() {
		System.out.println("Welcome, Mr/Ms." + this.getName() + "\n"
				...
				+ "Please insert 31 for Quality of Mobile.\n"
				+ "Please insert 32 for Quality of the Internet.\n"
				+ "Please insert 33 for Quality of the Satellite TV.\n"
				+ "Please insert 34 for Quality of Customer Service.\n"
	...
	//** Method to calculate the Quality of Mobile from answer sheet(ArrayList) from Questionnaire's field q2.*/
	public static void getQ2RESULTS() {
		System.out.println("---The Quality of mobile---");
		...
		for (Questionnaire k: Questionnaire.Qs) {
			if (k.q2 == 1) {
				...
				a4++;
			} else { // k.q2 == 5, definitely q2 must be either 1 either 2 either 3 either 4 either 5.
				a5++;
			}
		}
