...
//Δήλωση ιδιωτικών μεταβλητών στιγμιοτύπου (απαντήσεις questionnaire)
	private int q1 = 0;
	private int q2 = 0;
	private int q3 = 0;
	private int q4 = 0;
	...
	//Δημιουργία καινούριου questionnaire
	...
	//Δημιουργία μεθόδων get για τις απαντήσεις
	public int getQ1() {
		return this.q1;
	}
	...
	//Μέθοδος προσδιορισμού των ερωτήσεων του ερωτηματολογίου και των απαντήσεων των πελατών
